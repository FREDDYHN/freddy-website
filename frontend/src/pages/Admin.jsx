                    ...
                    <td className="p-3 align-top text-[10px]">
                      ...
                      {c._packaging?.length > 0 && (
                        <button onClick={() => {
                          ...
                          html += '<p style="font-weight:700;color:#c0392b;margin:0 0 6px">⚠️ 请分两笔转账支付，切勿合并为一笔</p>'
                          ...
                          html += '<p style="margin:6px 0 0;font-weight:700;color:#c0392b">未填写转账附言的转账，一律不予处理。</p>'
                          html += '</div>'
                          html += '</div>'
                          html += '</body></html>'
