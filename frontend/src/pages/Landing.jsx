  ...
  return (
    <div>
      <section className="text-white text-center py-14 px-4" style={{ background: 'linear-gradient(135deg, #3d5a48 0%, #527a60 50%, #3d5a48 100%)' }}>
        ...
        <Link to="/signup/packaging" className="inline-block px-7 py-3 bg-gold text-white text-sm font-bold rounded-lg hover:-translate-y-0.5 hover:shadow-lg transition-all" style={{ background: '#5a9470' }}>立即免费签约 →</Link>
      </section>
