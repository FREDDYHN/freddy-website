...
const cards = [
  { to: '/packaging', title: '包装法授权代表', tag: '2026 强制', price: `€${AR_TIERS.basic.feeEur}`, priceEur: AR_TIERS.basic.feeEur, period: '/ 年', desc: 'LIVANTO GmbH 担任授权代表，承担双元系统对接、LUCID 数据申报、完整性声明及官方通信等全部法定义务。' },
  { to: '/battery',   title: '德国电池法 BattG',                    price: `€${BATTERY_STARTING_PRICE}`, priceEur: BATTERY_STARTING_PRICE, period: '/ 年起', desc: 'WEEE Return GmbH 担任授权代表，负责 EAR 注册、回收处置方案、年度申报及与 UBA 的全部官方沟通。' },
  { to: '/weee',      title: '德国 WEEE 电子电气法', tag: '6 大类别', price: `€${WEEE_STARTING_PRICE}`, priceEur: WEEE_STARTING_PRICE, period: '/ 年起', desc: 'WEEE Return GmbH 担任授权代表，覆盖全部 6 个设备类别，承担 EAR 注册、担保确认及年度数据申报全流程。' },
]
