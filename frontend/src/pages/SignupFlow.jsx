      ...
      {step === 1 && isPkg && (
        <div className="bg-white border border-gray-100 rounded-lg p-6 space-y-4">
          ...
          <ul className="text-sm text-gray-500 list-disc pl-5 space-y-1">
            ...
            <li>2026年度<span className="font-semibold text-orange-600">还没有预申报的</span>，请在下方填写预申报的包装种类和重量，系统将为您算出金额，在您登录客户端后，请<span className="font-semibold text-orange-600">查看费用明细并完成付款，上传付款凭证</span>。</li>
          </ul>
          {/* 8 种材料平铺表格 */}
