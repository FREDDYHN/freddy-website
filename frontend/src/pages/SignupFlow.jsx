      ...
      {step === 1 && isPkg && (
        <div className="bg-white border border-gray-100 rounded-lg p-6 space-y-4">
          ...
          <ul className="text-sm text-gray-500 list-disc pl-5 space-y-1">
            <li>2026年度<span className="font-semibold text-orange-600">已经自行做过预申报的</span>，需将已预申报的包装种类和重量，如实填写在下方，并在登录客户端后<span className="font-semibold text-orange-600">上传预申报凭证/发票</span>。</li>
