  ...
  return (
    <div>
      ...
      <section className="packaging-gradient text-white py-16 px-4 text-center">
        ...
        <p className="text-xl font-bold text-white">€{AR_TIERS.basic.feeEur} / 年起</p>
        <div className="mt-6">
          <Link to="/signup" className="inline-block px-6 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary-light transition-colors">
            立即签约 →
          </Link>
        </div>
      </section>
