  ...
  return (
    <div>
      <section className="text-white text-center py-14 px-4" style={{ background: 'linear-gradient(135deg, #4a5d50, #5f7565, #4a5d50)' }}>
        ...
        <Link to="/signup/weee" className="inline-block px-7 py-3 text-white text-sm font-bold rounded-lg hover:-translate-y-0.5 transition-all" style={{ background: '#6b8a75' }}>在线签约 WEEE →</Link>
      </section>
