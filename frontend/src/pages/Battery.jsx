  ...
  return (
    <div>
      <section className="battery-gradient text-white py-16 px-4 text-center">
        ...
        <p className="text-xl font-bold text-white">€{BATTERY_STARTING_PRICE}/年起</p>
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <a href="/signup?type=battery" className="inline-block px-6 py-3 bg-primary text-white font-semibold rounded-lg hover:bg-primary-light transition-colors">
            在线签约电池法 →
          </a>
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border border-gray-100 mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 mt-6">
            {[
              ...
              <div key={i} className="p-4 bg-blue-50 rounded-lg text-sm">
                <h3 className="font-bold text-primary mb-1">{c.title}</h3>
                <p className="text-primary">{c.desc}</p>
              </div>
            ))}
          </div>
        </div>
